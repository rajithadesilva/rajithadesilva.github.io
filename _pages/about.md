...
- [Keypoint Semantic Integration for Improved Feature Matching in Outdoor Agricultural Environments](/publication/2025-01-01-keypoint-semantic-integration)
- [Vision based crop row navigation under varying field conditions in arable fields](/publication/2024-02-01-vision-based-crop-row-navigation)
- [Deep learning-based crop row detection for infield navigation of agri-robots](/publication/2023-08-01-deep-learning-crop-row-detection)
- [Leaving the Lines Behind: Vision-Based Crop Row Exit for Agricultural Robot Navigation](/publication/2023-06-01-leaving-the-lines-behind)

## Profiles

- [Google Scholar](https://scholar.google.com/citations?user=ymXP0CAAAAAJ)
- [GitHub](https://github.com/rajithadesilva/)
- [LinkedIn](https://www.linkedin.com/in/rajithadesilva/)
- [YouTube](https://www.youtube.com/watch?v=7BjCjCdQG1I)
